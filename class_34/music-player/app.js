...
// const getString = (item) => typeof item === 'string';
// const getNumber = (item) => typeof item === 'number';

// function getByCondition(arr, conditions) {
//     return arr.filter(item => {
//         if (conditions.some(condition => condition(item))) {
//             return true; 
//         }
//         return false; 
//     });
...
// let arr = ['Rahul', 300, 'DSA', 400, true, 'Aman'];
// console.log(getByCondition(arr, [getString, getNumber]));
